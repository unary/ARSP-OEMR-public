...
<form method='post' action='counselor_pay_report.php' id='theform'>
  ...
  if ($_POST['form_refresh']) {
    ...
    $arows = array();
      ...
      $query = "SELECT a.pid, a.encounter, a.post_time, a.code, a.modifier, a.pay_amount, " .
        ...
        "b.provider_id, b.units, b.c_pay,b.c_prepaid,b.c_travel,fe.date AS encounterdate " .
      ...
      while ($row = sqlFetchArray($res)) {
        ...
        $arows[$key]['encounterdate'] = $encounter_date;
...
?>
 ...
 <tr bgcolor="#ddddff">
  <td class="detail" colspan="<?php echo ($form_cptcode ? 5 : 5) + ($form_procedures ? 2 : 2); ?>">
...
?>
 ...
 <td class="detail">
   <?php echo oeFormatShortDate($row['encounterdate']) ?>
  </td>
  <td class="detail">

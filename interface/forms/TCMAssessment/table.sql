...
INSERT INTO `TCMAFunctionalTypes` (`Id`, `Label`, `Description`, `Priority`, `Disabled`) VALUES (NULL, 'Family Support / Family Education', 'suport services or educational needs related to client\'s treatment', 2, '0');
...
INSERT INTO `TCMAFunctionalTypes` (`Id`, `Label`, `Description`, `Priority`, `Disabled`) VALUES (NULL, 'Legal', 'probation, competency evaluations, child welfaire, custody/parenting plans', 7, '0');
